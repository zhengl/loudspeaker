...
describe("GestureDetector", function(){
	it("reacts to single step", function(){
		...
		var step = new GestureStep(Event.Mouse.MOUSE_DOWN, action);
		var detector = new GestureDetector(step);
		detector.detect(createEvent(Event.Mouse.MOUSE_DOWN));
	...
	it("reacts to subsequent step", function(){
		...
		var step1 = new GestureStep(Event.Mouse.MOUSE_DOWN, action1);
		var step2 = new GestureStep(Event.Mouse.MOUSE_DOWN, action2);
	...
	it("rewinds", function(){
		var step1 = new GestureStep(Event.Mouse.MOUSE_DOWN, function(){});
		var step2 = new GestureStep(Event.Mouse.MOUSE_UP, function(){});
		step1.addNextStep(step2);
