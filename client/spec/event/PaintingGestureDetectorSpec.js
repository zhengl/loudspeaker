...
describe("PaintingGestureDetector", function(){
	...
	it("triggers START_DRAWING after MOUSE_DOWN, MOVE_TO and MOVE_TO", function(){
		detector.detect(createEvent(Event.Mouse.MOUSE_DOWN, 10, 10, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 20, 20, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 30, 30, page));
	...
	it("triggers DRAW_TO after MOUSE_DOWN, MOVE_TO, MOVE_TO and MOVE_TO", function(){
		...
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 20, 20, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 30, 30, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 40, 40, page));
	...
	it("triggers FINISH_DRAWING after MOUSE_DOWN, MOVE_TO, MOVE_TO and MOUSE_UP", function(){
		...
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 20, 20, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 30, 30, page));
		detector.detect(createEvent(Event.Mouse.MOUSE_UP, 40, 40, page));
	...
	it("triggers nothing after MOUSE_UP", function(){
		detector.detect(createEvent(Event.Mouse.MOUSE_UP, 30, 30, page));
	...
	it("triggers nothing after MOUSE_DOWN, MOUSE_UP, MOVE_TO", function(){
		detector.detect(createEvent(Event.Mouse.MOUSE_DOWN, 10, 10, page));
		detector.detect(createEvent(Event.Mouse.MOUSE_UP, 10, 10, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 10, 10, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 10, 10, page));
	...
	it("triggers START_DRAWING after MOUSE_DOWN, MOVE_TO, MOVE_TO, MOUSE_UP and MOUSE_DOWN", function(){
		...
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 20, 20, page));
		detector.detect(createEvent(Event.Mouse.MOUSE_UP, 30, 30, page));
		detector.detect(createEvent(Event.Mouse.MOUSE_DOWN, 40, 40, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 50, 50, page));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 50, 50, page));
	...
	it("triggers nothing MOUSE_DOWN, MOVE_TO, MOVE_TO on item with no context", function(){
		var line = new Line();
		detector.detect(createEvent(Event.Mouse.MOUSE_DOWN, 10, 10, line));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 20, 20, line));
		detector.detect(createEvent(Event.Mouse.MOVE_TO, 20, 20, line));
